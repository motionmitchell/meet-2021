...
app.get("/movies",  (req, res) =>{
	client.connect();
	const query = 'SELECT * FROM view_movies';
	...
	/*
    connection.query('SELECT * FROM view_movies', (err, rows) => {
        if(err) throw err;
...
app.get("/movie/:id",  (req, res) =>{
	...
	console.log("ID: "+id);
    connection.query('SELECT * FROM view_movies WHERE id ='+id, (err, rows) => {
        if(err) throw err;
       // console.log('The data from users table are: \n', rows);
...
app.get("/genre/:id",  (req, res) =>{
	const id = req.params.id;
	console.log("ID: "+id);
    connection.query('SELECT name FROM genres WHERE id ='+id, (err, rows) => {
        if(err) throw err;
       // console.log('The data from users table are: \n', rows);
...
app.get("/director/:id",  (req, res) =>{
	const id = req.params.id;
	console.log("ID: "+id);
    connection.query('SELECT * FROM directors WHERE id ='+id, (err, rows) => {
        if(err) throw err;
       // console.log('The data from users table are: \n', rows);
